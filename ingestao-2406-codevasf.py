...
def main():
    ...
    container_name = 'codevasf-2406'

    arquivos = [
        {"local_path": r"T:\\13.Planejamento\\01. LD e CR\\2406 - CODEVASF\\01. LISTA DE DOCUMENTOS\\LD-2406-GR-PLN-GRC-001.xlsm", 
         "blob_name": "LD-2406-GR-PLN-GRC-001.xlsm"},

        {"local_path": r"T:\\13.Planejamento\\01. LD e CR\\2406 - CODEVASF\\02. CRONOGRAMA\\CS-2406-GR-PLN-GRC-001=R0.xlsx", 
         "blob_name": "CS-2406-GR-PLN-GRC-001=R0.xlsx"},
        ...
        {"local_path": r"T:\\13.Planejamento\\03. PLN_Operacional\\01 - PLANEJAMENTO E CONTROLE\\COORDENACAO\\CONTROLES (POWER BI)\\240124\\HORA_MO\\cadastro horas 1.xlsx", 
         "blob_name": "cadastro_horas_1.xlsx"},
    ]
