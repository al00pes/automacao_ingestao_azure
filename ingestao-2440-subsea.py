...
def main():
    ...
    arquivos = [
        {"local_path": r"T:\\13.Planejamento\\01. LD e CR\\2440 - SUBSEA7\\01. LISTA DE DOCUMENTOS\\LD-2440-PE-ACA-PLN-GER-001-R0.xlsx", 
         "blob_name": "LD-2440-PE-ACA-PLN-GER-001-R0.xlsx"},

        {"local_path": r"T:\\13.Planejamento\\01. LD e CR\\2440 - SUBSEA7\\02. CRONOGRAMA\\CS-2440-PE-ACA-PLN-GER-001.xlsx", 
         "blob_name": "CS-2440-PE-ACA-PLN-GER-001.xlsx"},

        {"local_path": r"T:\\13.Planejamento\\03. PLN_Operacional\\01 - PLANEJAMENTO E CONTROLE\\COORDENACAO\\CONTROLES (POWER BI)\\240124\SUBSEA\\faturamento_2440.xlsx", 
         "blob_name": "faturamento_2440.xlsx"},

        {"local_path": r"T:\\13.Planejamento\\03. PLN_Operacional\\01 - PLANEJAMENTO E CONTROLE\\COORDENACAO\\PAR\\2440 - SUBSEA\\PAR_2440_SUBSEA_R0.xlsx", 
         "blob_name": "PAR_2440_SUBSEA_R0.xlsx"} 
    ]
