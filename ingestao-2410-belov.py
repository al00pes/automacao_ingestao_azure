...
def main():
    ...
    container_name = 'belov-2410'

    arquivos = [
        {"local_path": r"T:\\13.Planejamento\\01. LD e CR\\2410 - BELOV\\01. LISTA DE DOCUMENTOS\\LD-2410-GR-PLN-GRC-001_R7.xlsx", 
         "blob_name": "LD-2410-GR-PLN-GRC-001_R7.xlsx"},
        {"local_path": r"T:\\13.Planejamento\\01. LD e CR\\2410 - BELOV\\02. CRONOGRAMA\\CS-2410-GR-PLN-GER-001=R2.xlsx", 
         "blob_name": "CS-2410-GR-PLN-GER-001=R2.xlsx"},
