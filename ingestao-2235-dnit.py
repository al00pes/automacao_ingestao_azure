...
def main():
    ...
    container_name = 'dnit-2235'

    arquivos = [
        {"local_path": r"T:\\13.Planejamento\\01. LD e CR\\2235 - DNIT - ECLUSAS\\01. LISTA DE DOCUMENTOS\\LD-2235-GR-PLN-GRC-001 OK.xlsm", 
         "blob_name": "LD-2235-GR-PLN-GRC-001_OK.xlsm"},
        ...
        {"local_path": r"T:\\13.Planejamento\\03. PLN_Operacional\\01 - PLANEJAMENTO E CONTROLE\\COORDENACAO\\CONTROLES (POWER BI)\\240124\DNIT(2235)\\DRE_Eclusas_SP_5.xlsx", 
         "blob_name": "DRE_Eclusas_SP_5.xlsx"},
