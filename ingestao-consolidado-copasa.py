...
def main():
    ...
    container_name = 'consolidado-copasa'

    arquivos = [
        {"local_path": r"T:\\13.Planejamento\\01. LD e CR\\0000 - RESUMO PROJ. ATIVOS\\PLN_RESUMO DE PROJETOS EM ANDAMENTO_R01.xlsx", 
         "blob_name": "PLN_RESUMO_PROJETOS_ANDAMENTO_R01.xlsx"},
        {"local_path": r"T:\\13.Planejamento\\01. LD e CR\\0000 - COPASA\\06. BASE DE DADOS\\planilha_base_copasa.xlsx", 
         "blob_name": "planilha_base_copasa.xlsx"},
    ]
