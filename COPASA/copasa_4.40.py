...
def main():
    ...
    container_name = 'copasa-'

    arquivos = [
        {"local_path": r"T:\\13.Planejamento\\01. LD e CR\\0000 - COPASA\\02. CRONOGRAMA\\CS-4.40-2022-PB-PLN-GRC-001-R0.xlsx", 
         "blob_name": "CS-4.40-2022-PB-PLN-GRC-001-R0.xlsx"},
        {"local_path": r"T:\\13.Planejamento\\02. PLN_Operacional\\01 - PLANEJAMENTO E CONTROLE\\COORDENACAO\\CONTROLES (POWER BI)\\240124\\COPASA\\faturamento_4.40.xlsx", 
         "blob_name": "faturamento_4.40.xlsx"},
